...
LEDWrite(uint32_t ui32LEDMask, uint32_t ui32LEDValue)
{
    ...
    if(ui32LEDMask & CLP_D1)
    {
        ...
        {
            ROM_GPIOPinWrite(CLP_D1_PORT, CLP_D1_PIN, CLP_D1_PIN);
        }
        else
        {
            ROM_GPIOPinWrite(CLP_D1_PORT, CLP_D1_PIN, 0);
        }
    }
    ...
    if(ui32LEDMask & CLP_D2)
    {
        ...
        {
            ROM_GPIOPinWrite(CLP_D2_PORT, CLP_D2_PIN, CLP_D2_PIN);
        }
        else
        {
            ROM_GPIOPinWrite(CLP_D2_PORT, CLP_D2_PIN, 0);
        }
    }
    ...
    if(ui32LEDMask & CLP_D3)
    {
        ...
        {
            ROM_GPIOPinWrite(CLP_D3_PORT, CLP_D3_PIN, CLP_D3_PIN);
        }
        else
        {
            ROM_GPIOPinWrite(CLP_D3_PORT, CLP_D3_PIN, 0);
        }
    }
    ...
    if(ui32LEDMask & CLP_D4)
    {
        ...
        {
            ROM_GPIOPinWrite(CLP_D4_PORT, CLP_D4_PIN, CLP_D4_PIN);
        }
        else
        {
            ROM_GPIOPinWrite(CLP_D4_PORT, CLP_D4_PIN, 0);
        }
    }
}
...
void LEDRead(uint32_t *pui32LEDValue)
{
    *pui32LEDValue = 0;
    ...
    //
    if(ROM_GPIOPinRead(CLP_D4_PORT, CLP_D4_PIN))
    {
    ...
    // Read the pin state and set the variable bit if needed.
    //
    if(ROM_GPIOPinRead(CLP_D3_PORT, CLP_D3_PIN))
    {
    ...
    // Read the pin state and set the variable bit if needed.
    //
    if(ROM_GPIOPinRead(CLP_D2_PORT, CLP_D2_PIN))
    {
    ...
    // Read the pin state and set the variable bit if needed.
    //
    if(ROM_GPIOPinRead(CLP_D1_PORT, CLP_D1_PIN))
    {
