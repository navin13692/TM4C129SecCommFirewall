...
#include "../portable/Compiler/CCS/pack_struct_start.h"
struct xETH_HEADER
{
...
#include "../portable/Compiler/CCS/pack_struct_end.h"
...
rather than duplicated in its own variable. */
#define ipLOCAL_MAC_ADDRESS ( xDefaultPartUDPPacketHeader.ucBytes )  //NAvin
 ...
 */
eFrameProcessingResult_t eARPProcessPacket( ARPPacket_t * const pxARPFrame, NetworkBufferDescriptor_t * const pxNetworkBuffer  );
